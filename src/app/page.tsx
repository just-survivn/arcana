    ...
    {/* <ThemeSwitcher /> */}
      <main className="flex min-h-screen flex-col items-center justify-between p-5 lg:p-12">
        ...
        <div className="relative flex flex-col  place-items-center ">
          ...
          <p className='text-lg md:text-lg px-6 max-w-3xl text-center m-5 text-slate-800 dark:text-slate-100 font-thin' dangerouslySetInnerHTML={{
            __html: description
          }}>
          </p>
          ...
          <form className="space-y-6" action="#" method="POST">
            <div>
              ...
              <div className="mt-2 flex-col flex lg:flex md:flex-row">
                ...
                <button className='ml-0 bg-slate-900 sm:w-auto border-slate-800 dark:border-slate-100	rounded-none mt-2 md:mt-0	p-2 border-2 dark:text-white hover:bg-slate-950'>Request Access</button>
              </div>
            </div>
          </form>
        </div> */}
